# -*- coding: utf-8 -*-
"""
Created on Tue Feb 11 19:04:07 2025
...
grid_search = GridSearchCV(gbr_model, param_grid, scoring='neg_mean_squared_error', cv=5)
...
# 8. 使用交叉验证评估模型性能
cv_scores = cross_val_score(best_gbr_model, X_train, y_train, cv=5, scoring='neg_mean_squared_error')
print(f"交叉验证得分（负均方误差）：{cv_scores}")
